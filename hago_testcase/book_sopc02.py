...
class TestBookSOPC02(unittest.TestCase):
    ...
    def testbooksopc0200(self):
        try:
            print("Book SOPC02-00 Read Application Notes start")
            ...
            self.driver.save_screenshot(test_dir+"02_00_declaration.png")
            print("Screenshot 02_00_declaration is taken")
            time.sleep(2)
            ...
            ## Yes in this case
            self.driver.save_screenshot(test_dir+"02_00_yes_received_healthcare_service.png")
            print("Screenshot 02_00_yes_received_healthcare_service is taken")
            time.sleep(2)
            self.driver.find_element_by_xpath("//*[@text='"+Low_Case_Confirm_button+"']").click()
            time.sleep(2)

            ## Application Notes is shown
            print("Book SOPC02-00 Scenario 01 Application Notes is shown")
            self.driver.save_screenshot(test_dir+"02_00_Application_Notes.png")
            print("Screenshot 02_00_Application_Notes is taken")
            time.sleep(5)

            ## Click scroll icon to scroll down
            print("Book SOPC02-00 Scenario 02 Click scroll icon to scroll down")
            WebDriverWait(self.driver, 10).until(expected_conditions.presence_of_element_located((By.XPATH,"//*[@class='android.widget.ImageView' and ./parent::*[@class='android.view.ViewGroup']]")))
            self.driver.find_element_by_xpath("//*[@class='android.widget.ImageView' and ./parent::*[@class='android.view.ViewGroup']]").click()
            self.driver.save_screenshot(test_dir+"02_00_Application_Notes.png")
            print("Screenshot 02_00_Application_Notes is taken")
            ...
            print("Book SOPC02-00 Scenario 03 Click Cancel button to close Application Notes")
            self.driver.find_element_by_xpath("//*[@text='"+cancel_button+"']").click()
            time.sleep(2)

        except TimeoutException:
            print("Book SOPC02-00 Read Application Notes Timeout Exception")
            assert(False)
        except Exception:
            print("Book SOPC02-00 Read Application Notes Exception")
            assert(False)
        finally:
            print("Book SOPC02-00 Read Application Notes finish")

    def testbooksopc0201(self):
        try:
            print("Book SOPC02-01 Input Patient's information in application process start")
            ...
            print("Book SOPC02-01 Scenario 01 The Progress Bar with 1st icon highlighted is displayed")
            self.driver.save_screenshot(test_dir+"02_01_Progress_bar_1st_icon.png")
            print("Screenshot 02_01_Progress_bar_1st_icon is taken")
            time.sleep(2)

            ## Patient's data in 4 input fields: HKID/Birth Certificate, Surname, Given Name, HK mobile phone number are blanked
            print("Book SOPC02_01 Scenario 02 Patient's data in 4 input fields: HKID/Birth Certificate, Surname, Given Name, HK mobile phone number are blank")
            time.sleep(2)

            self.driver.save_screenshot(test_dir+"02_01_Patient_data_blank.png")
            print("Screenshot 02_01_Patient_data_blank is taken")
            time.sleep(2)
            ...
            self.driver.save_screenshot(test_dir+"02_01_Patient_data_input.png")
            print("Screenshot 02_01_Patient_data_input is taken")
            time.sleep(2)
            ...
            print("Book SOPC02_01 Scenario 03 The Specialty and Hospital can be input by user")
            self.driver.save_screenshot(test_dir+"02_01_Specialty_Hospital.png")
            print("Screenshot 02_01_Specialty_Hospital is taken")
            time.sleep(2)

            ## Click Next Button to go to next screen
            print("Book SOPC02_01 Scenario 04 Click Next Button to go to next screen")
            self.driver.save_screenshot(test_dir+"02_01_Next_Button.png")
            print("Screenshot 02_01_Next_Button is taken")
            time.sleep(2)
            ...
            print("Book SOPC02-01 Input Patient's information in application process Timeout Exception")
            assert(False)
        except Exception:
            print("Book SOPC02-01 Input Patient's information in application process Exception")
            assert(False)
        finally:
            print("Book SOPC02-01 Input Patient's information in application process finish")

    def testbooksopc0202(self):
        try:
            print("Book SOPC02-02 Take Photo in Submit Document page in application process start")
            ...
            print("Book SOPC02-02 Scenario 01 The Progress Bar with 2nd icon highlighted is displayed")
            self.driver.save_screenshot(test_dir+"02-02_Progress_bar_2nd_icon.png")
            print("Screenshot 02-02_Progress_bar_2nd_icon is taken")
            time.sleep(2)
            ...
            print("Book SOPC02-02 Scenario 02 Functions of button related to taking photo in Patient's Address")
            self.driver.save_screenshot(test_dir+"02-02_take_photo_interface.png")
            print("Screenshot 02-02_take_photo_interface is taken")
            time.sleep(2)
            ...
            print("Book SOPC02-02 Scenario 03 Photo of document can be taken")
            self.driver.save_screenshot(test_dir+"02-02_take_photo_document_done.png")
            print("Screenshot 02-02_take_photo_document_done is taken")
            time.sleep(2)
            ...
            print("Book SOPC02-02 Scenario 04 Change outlook of icons in Patient's Address after the process of Take Photo")
            self.driver.save_screenshot(test_dir+"02-02_patient_address_after_taking_photo_document.png")
            print("Screenshot 02-02_patient_address_after_taking_photo_document is taken")
            time.sleep(2)

            ## Type In Patient's Address
            print("Book SOPC02-02 Type In Patient's Address")
            ...
            time.sleep(2)
            print("Book SOPC02-02-01 Scenario 01 Change of interface when clicking 'Pen' button")
            self.driver.save_screenshot(test_dir+"02_02_01_typing_patient_address_box.png")
            print("Screenshot 02_02_01_typing_patient_address_box is taken")
            time.sleep(2)
            ...
            time.sleep(2)
            print("Book SOPC02-02-01 Scenario 02 Input data to patient's address box")
            self.driver.save_screenshot(test_dir+"02_02_01_typing_patient_address_box.png")
            print("Screenshot 02_02_01_typing_patient_address_box is taken")
            ...
            ## Click Next Button to go to next screen
            print("Book SOPC02-02-01 Scenario 03 Click Next Button to go to next screen")
            self.driver.save_screenshot(test_dir+"02_02_01_Next_Button.png")
            print("Screenshot 02_02_01_Next_Button is taken")
            time.sleep(2)
            ...
            print("Book SOPC02-02 Take Photo in Submit Document page in application process Timeout Exception")
            assert(False)
        except Exception:
            print("Book SOPC02-02 Take Photo in Submit Document page in application process Exception")
            assert(False)
        finally:
            print("Book SOPC02-02 Take Photo in Submit Document page in application process finish")

    def testbooksopc0203(self):
        try:
            print("Book SOPC02-03 Scanning QR code on Referral letter start")
            ...
            print("Book SOPC02-03 Scenario 01 The Progress Bar with 3rd icon highlighted is displayed")
            self.driver.save_screenshot(test_dir+"02_03_Progress_bar_3rd_icon.png")
            print("Screenshot 02_03_Progress_bar_3rd_icon is taken")
            time.sleep(2)

            ## Screen of scanning QR code
            print("Book SOPC02-03 Scenario 02 Screen of scanning QR code")
            time.sleep(2)

            ## Wait 20 seconds for manually scanning invalid QR code
            print("Book SOPC02-03 Scenario 03 Process when displayed pop-up of scanning QR code failed")
            time.sleep(2)
            ...
            self.driver.save_screenshot(test_dir+"02_03_invalid_QR_code.png")
            print("Screenshot 02_03_invalid_QR_code is taken")

            ## Clicked Re-scan button
            self.driver.find_element_by_xpath("//*[@id='button1']").click()
            time.sleep(2)
            print("Clicked Re-scan button")
            self.driver.save_screenshot(test_dir+"02_03_rescan_QR_code.png")
            print("Screenshot 02_03_rescan_QR_code is taken")

            ## Wait 20 seconds for manually scanning QR code with unmatched HKID
            time.sleep(2)
            print("QR code with unmatched HKID is scanned")
            WebDriverWait(self.driver, 20).until(expected_conditions.presence_of_element_located((By.XPATH,"//*[@id='button1']")))
            self.driver.save_screenshot(test_dir+"02_03_unmatched_HKID_QR_code.png")
            print("Screenshot 02_03_unmatched_HKID_QR_code is taken")
            ...
            self.driver.save_screenshot(test_dir+"02_03_reinput_HKID.png")
            print("Screenshot 02_03_reinput_HKID is taken")
            ...
            WebDriverWait(self.driver, 20).until(expected_conditions.presence_of_element_located((By.XPATH,"//*[@id='button1']")))
            self.driver.save_screenshot(test_dir+"02_03_unmatched_Speciality_QR_code.png")
            print("Screenshot 02_03_unmatched_Speciality_QR_code is taken")
            ...
            print("Book SOPC02-03 Scenario 04 Process when displayed pop-up of scanning QR code success")
            WebDriverWait(self.driver, 20).until(expected_conditions.presence_of_element_located((By.XPATH,"//*[@id='button1']")))
            time.sleep(2)
            print("QR code is scanned successfully")
            self.driver.save_screenshot(test_dir+"02_03_valid_QR_code_scanned.png")
            print("Screenshot 02_03_valid_QR_code_scanned is taken")
            time.sleep(2)
            ...
            print("Book SOPC02-03 Scenario 05 Display of information of patient in patient information screen")
            print("User is on check data page which shows information of patient")
            self.driver.save_screenshot(test_dir+"02_03_check_data_page_from_QR_code_scanned.png")
            print("Screenshot 02_03_check_data_page_from_QR_code_scanned is taken")
            time.sleep(3)

        except TimeoutException:
            print("Book SOPC02-03 Scanning QR code on Referral letter Timeout Exception")
            assert(False)
        except Exception:
            print("Book SOPC02-03 Scanning QR code on Referral letter Exception")
            assert(False)
        finally:
            print("Book SOPC02-03 Scanning QR code on Referral letter finish")

    def testbooksopc020301(self):
        try:
            print("Book SOPC02-03-01 Take Photo in other Referral letter in application process start")
            ...
            time.sleep(2)
            print("Book SOPC02-03-01 Scenario 01 Functions of buttons related to taking photo in other Referral letter")
            self.driver.save_screenshot(test_dir+"02_03_01_take_photo_referral_letter.png")
            print("Screenshot 02_03_01_take_photo_referral_letter is taken")
            time.sleep(2)
            ...
            print("Book SOPC02-03-01 Scenario 02 Functions of different buttons in Take Photo interface")
            self.driver.save_screenshot(test_dir+"02_03_01_Photo_interface_screen.png")
            print("Screenshot 02_03_01_Photo_interface_screen is taken")
            time.sleep(2)
            ...
            print("Book SOPC02-03-01 Scenario 03 Change outlook of icons in other Referral letter after the process of Take Photo")
            self.driver.save_screenshot(test_dir+"02_03_01_Photo_taken_on_referral_letter_page.png")
            print("Screenshot 02_03_01_Photo_taken_on_referral_letter_page is taken")
            time.sleep(3)
            ...
            time.sleep(2)
            self.driver.save_screenshot(test_dir+"02_03_01_Zoom_Photo_taken_page.png")
            ...
            ## User is on check data page
            print("User is on check data page which shows information of patient")
            self.driver.save_screenshot(test_dir+"02_03_01_check_data_page_from_QR_code_scanned.png")
            print("Screenshot 02_03_01_check_data_page_from_QR_code_scanned is taken")
            time.sleep(3)

        except TimeoutException:
            print("Book SOPC02-03-01 Take Photo in other Referral letter in application process Timeout Exception")
            assert(False)
        except Exception:
            print("Book SOPC02-03-01 Take Photo in other Referral letter in application process Exception")
            assert(False)
        finally:
            print("Book SOPC02-03-01 Take Photo in other Referral letter in application process finish")

    def testbooksopc0204(self):
        try:
            print("Book SOPC02-04 Review and Submit Application start")
            ...
            print("Book SOPC02-04 Scenario 01 The Progress Bar with 4th icon highlighted is displayed")
            self.driver.save_screenshot(test_dir+"02_04_Progress_bar_4th_icon.png")
            print("Screenshot 02_04_Progress_bar_4th_icon is taken")
            time.sleep(2)
            ...
            print("Book SOPC02-04 Scenario 02 Correct patient's data displayed in patient document review pages")
            self.driver.save_screenshot(test_dir+"02_04_patient_data_check_data_page.png")
            print("Screenshot 02_04_patient_data_check_data_page is taken")
            time.sleep(2)

            ## Function of Edit and Submit button in Review page
            print("Book SOPC02-04 Scenario 03 Function of Edit and Submit button in Review page")
            time.sleep(2)
            ...
            time.sleep(2)
            self.driver.save_screenshot(test_dir+"02_04_edit_input_data_page.png")
            print("Screenshot 02_04_edit_input_data_page is taken")
            time.sleep(2)
            ...
            time.sleep(2)
            self.driver.save_screenshot(test_dir+"02_04_edit_specialty.png")
            print("Screenshot 02_04_edit_specialty is taken")
            time.sleep(2)
            ...
            time.sleep(2)
            self.driver.save_screenshot(test_dir+"02_04_edit_hospital.png")
            print("Screenshot 02_04_edit_hospital is taken")
            time.sleep(2)
            self.driver.press_keycode(4)
            time.sleep(2)
            ...
            self.driver.save_screenshot(test_dir+"02_04_edit_submit_document_page.png")
            print("Screenshot 02_04_edit_submit_document_page is taken")
            time.sleep(2)
            ...
            time.sleep(3)
            self.driver.save_screenshot(test_dir+"02_04_edit_referral_letter.png")
            print("Screenshot 02_04_edit_referral_letter is taken")
            time.sleep(2)
            self.driver.find_element_by_partial_link_text(cancel_button).click()
            time.sleep(2)

            ## Submit Referral Letter is edited
            self.driver.save_screenshot(test_dir+"02_04_edit_submit_referral_letter_page.png")
            print("Screenshot 02_04_edit_submit_referral_letter_page is taken")
            time.sleep(2)
            ...
            self.driver.find_element_by_xpath("//*[@class='android.view.ViewGroup' and ./*[@text='"+next_button+"']]").click()
            time.sleep(2)
            self.driver.save_screenshot(test_dir+"02_04_return_check_data_from_edit.png")
            print("Screenshot 02_04_return_check_data_from_edit is taken")
            time.sleep(3)
            ...
            print("Book SOPC02-04 Scenario 04 Display of Complete page and Reference code")
            time.sleep(2)
            ...
            self.driver.save_screenshot(test_dir+"02_04_progress_bar_buttons_reference_code.png")
            print("Screenshot 02_04_progress_bar_buttons_reference_code is taken")
            time.sleep(2)

            ## Function of buttons in Complete page
            print("Book SOPC02-04 Scenario 05 Function of buttons in Complete page")
            time.sleep(2)
            ...
            time.sleep(2)
            print("Book SOPC02-04 Scenario 05 Display of information pop-up window when clicked info icon")
            self.driver.save_screenshot(test_dir+"02-04_information_pop_up_reference_number.png")
            print("Screenshot 02-04_information_pop_up_reference_number is taken")
            time.sleep(2)
            ...
            time.sleep(2)
            print("Book SOPC02-04 Scenario 06 Go back to Book SOPC home screen after clicking Submit Application button")
            self.driver.save_screenshot(test_dir+"02-04_back_book_sopc_home_screen.png")
            print("Screenshot 02-04_back_book_sopc_home_screen is taken")
            time.sleep(2)
            ...
            print("Book SOPC02-04 Review and Submit Application Timeout Exception")
            assert(False)
        except Exception:
            print("Book SOPC02-04 Review and Submit Application Exception")
            assert(False)
        finally:
            print("Book SOPC02-04 Review and Submit Application finish")
